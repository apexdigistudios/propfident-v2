    ...
    <main className="min-h-screen flex flex-col relative overflow-hidden bg-background text-foreground transition-colors duration-200 font-sans">
      ...
      <nav className="z-10 flex items-center justify-between px-6 py-4 border-b border-border/40 bg-background/80 backdrop-blur-md">
        <div className="flex items-center gap-2">
          ...
          <span className="rounded bg-primary/10 px-1.5 py-0.5 text-[10px] font-medium text-primary border border-primary/20 font-rounded">
            v2
          </span>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            href="#pricing"
            className="bg-primary hover:bg-primary-hover text-primary-foreground px-4 py-2 rounded-md text-sm font-medium transition-all shadow-[0_0_15px_rgba(124,58,237,0.3)] hover:shadow-[0_0_25px_rgba(124,58,237,0.5)] font-rounded"
          >
            Get Lifetime Access
          </a>
        </div>
      ...
      <section className="z-10 flex-1 flex flex-col items-center justify-center px-4 py-20 text-center max-w-5xl mx-auto">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-surface border border-border/60 text-xs text-muted-foreground mb-8 font-rounded">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
          <a
            href="#pricing"
            className="w-full sm:w-auto flex items-center justify-center gap-2 bg-primary hover:bg-primary-hover text-primary-foreground px-8 py-4 rounded-md text-base font-medium transition-all shadow-[0_0_20px_rgba(124,58,237,0.4)] font-rounded"
          >
          ...
          <a
            href="#tools"
            className="w-full sm:w-auto flex items-center justify-center gap-2 bg-surface hover:bg-surface-hover border border-border px-8 py-4 rounded-md text-base font-medium transition-all text-foreground font-rounded"
          >
            Explore Free Tools
          </a>
        </div>
        ...
        <div className="mt-16 flex flex-col sm:flex-row items-center gap-6 p-6 rounded-xl border border-primary/30 bg-primary/5 backdrop-blur-sm w-full max-w-2xl text-left">
          ...
          <div className="flex-1 text-center sm:text-left">
            <h3 className="font-semibold text-lg text-foreground mb-1 font-rounded">Founder's Lifetime Launch</h3>
          ...
          <div className="flex gap-3 text-center items-center justify-center font-mono">
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-muted-foreground uppercase font-mono">Days</span>
            </div>
            <span className="text-2xl font-bold text-muted-foreground">:</span>
            <div className="flex flex-col">
              <span className="text-2xl font-bold text-foreground">08</span>
              <span className="text-[10px] text-muted-foreground uppercase font-mono">Hrs</span>
            </div>
          </div>
        </div>
      </section>
